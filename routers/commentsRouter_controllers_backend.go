...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/Qsnh/goa/controllers/backend:SettingController"] = append(beego.GlobalControllerRouter["github.com/Qsnh/goa/controllers/backend:SettingController"],
        beego.ControllerComments{
            Method: "SettingData",
            Router: `/backend/setting/data`,
            AllowHTTPMethods: []string{"get"},
            MethodParams: param.Make(),
            Filters: nil,
            Params: nil})
